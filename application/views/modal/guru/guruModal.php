...
<div class="modal fade bd-example-modal-lg" id='editData' tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <div class="form-group row">
            <input type="hidden" id="idEdit" name="id_guru" /> 
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title font-weight-bold" id="detailModalLabel">Detail Guru</h5>
                ...
                <div class="card shadow border-left-primary">
                    <div class="card-body">
                        <div class="row d-flex align-items-start">
                            ...
                            <div class="col-md-8">
                                <h6 class="font-weight-bold">Identitas Guru :</h6>
                                <hr>
