...
$(document).ready(function() {
    var table = $('#myTable').DataTable({
        ...
        "ajax": {
            ...
            "type": "POST",
            "data": function(d) {
                d.type = 3 // Menambahkan parameter tambahan
            }
        },
        "searchDelay": 500,
        "columns": [
            ...
            { "data": "tanggal_lahir" },
            {
                ...
                "render": function (data, type, row) {
                    return '<a href="<?php echo base_url('people/detailPeople/') ?>'+row.id+'" class="btn btn-success btn-sm" data-id="'+row.id+'"><i class="fas fa-eye"></i></a> ' +
                            '<button class="btn btn-primary btn-edit btn-sm" data-id="'+row.id+'"><i class="fas fa-wrench"></i></button> ' +
