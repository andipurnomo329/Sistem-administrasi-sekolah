    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="amount" class="col-sm-3 col-form-label">Nominal</label>
                    <div class="col-sm-6">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" name="isCash" id="isCash" value='1'/>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="amountEdit" class="col-sm-3 col-form-label">Nominal</label>
                    <div class="col-sm-9">
