...
class Pegawai extends BaseController
{
    ...
    function dataList(){
        ...
        else
        {
            ...
            $this->global['pageTitle'] = "Data Pegawai";
            $pageInfo['param']='7';
            $pageInfo['inOut']='I';
            $this->loadViews2("pegawai/pegawaiList", $this->global, $pageInfo , NULL, 'pegawai/pegawailModal');    
        }
    }
    ...
    public function updateData() {
        ...
        if ($updatePeople) {
            ...
            $updateGuru = $this->pm->editTask($guruInfo, $clean_data['id_pegawai']);
    ...
    public function generate_pdf() {
        ...
        $clean_data = $this->pm->getDatabyid($id_pegawai);
