    ...
    private function buildMenuTree($menuItems, $parentId = null) {
        ...
        foreach ($menuItems as $item) {
            ...
            if ($item->parent_id == $parentId) {
                // Gunakan ID parent yang sesuai untuk mencari child
                $children = $this->buildMenuTree($menuItems, $item->id); // Pastikan menggunakan ID yang benar di sini
                if ($children) {
    ...
    public function loginMe()
    {
        ...
        else
        {
            ...
            if (!empty($result))
            {
                ...
                $getMenuList = $this->login_model->getMenuList($result->roleId);
                $menuList = $this->buildMenuTree($getMenuList);
                // debug($result);die;
