    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="parent" class="col-sm-3 col-form-label">Kouta</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control required" id="kouta" name='kouta' placeholder="Jumlah Max Siswa" >
                    </div>
                </div>
            </div>
...
<div class="modal fade bd-example-modal-lg" id='editData' tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <div class="form-group row">
            <input type="hidden" class="form-control required" id="id_kelas_edit" name='id_kelas' >
                    <label for="nama" class="col-sm-3 col-form-label">Nama Kelas</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control required" id="nama_kelas_edit" name='nama_kelas' placeholder="Nama Kelas" >
                    </div>
                </div>
                <div class="form-group row">
                    <label for="url" class="col-sm-3 col-form-label">Tingkat</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control required" id="tingkat_edit" name='tingkat' placeholder="Tingkat" >
                    </div>
                </div>
                <div class="form-group row">
                    <label for="icon" class="col-sm-3 col-form-label">Jurusan</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control required" id="jurusan_edit" name='jurusan' placeholder="Jurusan" >
                    </div>
                </div>
                <div class="form-group row">
                    <label for="parent" class="col-sm-3 col-form-label">Tahun Ajaran</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control required" id="tahun_ajaran_edit" name='tahun_ajaran' placeholder="Tahun Ajaran" >
                    </div>
                </div>
                <div class="form-group row">
                    <label for="parent" class="col-sm-3 col-form-label">Tahun Ajaran</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control required" id="kouta_edit" name='kouta' placeholder="Tahun Ajaran" >
                    </div>
                </div>
            </div>
            <div class="modal-footer">
