            ...
            <div class="col-xl-12 col-lg-4">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Data Reporting Penerimaan </h6>
                    </div>
                    <div class="card-body">
...
$(document).ready(function() {
    ...
    $('#genReport').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo base_url('reporting/getIncomeFromJemaah') ?>',
            type: 'POST',
            data: $(this).serialize(),
            success: function(response) {
                ...
                data.data.forEach(function(item) {
                    htmls += '<tr><td class="text-center">'+noA+'</td><td>'+item.nama.toUpperCase()+'</td><td>'+item.tanggal_lahir+'</td><td class="text-center">'+item.umur_tahun+' Th '+item.umur_hari+' Hr</td><td class="text-center">'+item.totalTrx+'</td><td class="text-center">'+convertToRupiah(item.totalAmount)+'</td>';
                    ...
                    noA++;
                    totalA += parseFloat(item.totalAmount);
                });
    ...
    $('#myTable tbody').on('click', '.btn-dtl1', function () {
        ...
        drawTable(peopleId, tgl1, tgl2, 'I');
    });

    function drawTable(peopleId, tgl1, tgl2, inOut){
        var table = $('#pemasukan').DataTable({
            ...
            "columns": [
                ...
                { "data": "title" },
                { "data": "tanggal_transaksi","width": "14%" },
                { "data": "keterangan" },
    ...
    $('#exportData').on('click', function() {        
        ...
        $.ajax({
            url: '<?php echo base_url() ?>' + 'reporting/exportJemaahToExcell', // URL untuk memanggil controller di CI
            type: 'POST',
            ...
            success: function(data) {
                ...
                if (data instanceof Blob) {
                    ...
                    a.href = url;
                    a.download = 'Report_jemaah('+tglDonlot+').xlsx';
